...
<main>
		...
		<table border= 1 align=center>
            <tr>
			<div style="text-align: left;  font-family:inherit;"></div>
			<th>OrderID</th>
			<th>Status</th>
   ...
   $q="SELECT OrderID,status,trackingNo FROM `order` WHERE UserID=$_SESSION[ID]";
...
?>
			...
			<!--<tr>
			<th><div style="text-align: left;  font-family:inherit;">No.</div></th>
			<th>ID</th>
			<th>Status</th>
			<th>Tracking Number</th>
			<th></th>
			...
			<tr>
			<td>0001</td>
			<td>bell_2940@htomail.com</td>
			<td><div style="text-align: center;  font-family:inherit;">Paid</div></td>
			<td><div style="text-align: center;  font-family:inherit;">EL123456789TH</div></td>
			<td><div style="padding-left: 100px; text-align: right; font-family:inherit;"><img src="delete.png" alt="" width="20px" height="20px" /></div></td>
			</tr>-->
